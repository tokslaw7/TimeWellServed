...
<head>
    ...
    <meta name="Tokslaw" content="TimeWellServed">
    <meta name="description" content="TimeWellServed>
    <meta name="keywords" content="Responsive, HTML5, TimeWellServed, Landing, Software, Mobile App, SaaS, Startup, Creative, Digital Product">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- SITE TITLE -->
    <title>TimeWellServed</title>
    ...
    <!-- TEMPLATE CSS -->
    <!-- <link href="assets/cssblue-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/csscrocus-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/cssgreen-theme.css" rel="stylesheet"> -->
    <link href="assets/css/magenta-theme.css" rel="stylesheet">
    <!-- <link href="assets/csspink-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/csspurple-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/cssskyblue-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/cssred-theme.css" rel="stylesheet"> -->
    <!-- <link href="assets/cssviolet-theme.css" rel="stylesheet"> -->
...
<div id="page" class="page font--jakarta">
    ...
    <header id="header" class="tra-menu navbar-dark light-hero-header white-scroll">
        <div class="header-wrapper">
            ...
            <div class="wsmobileheader clearfix">
                <span class="smllogo"><img src="assets/images/logo-magenta.png" alt="mobile-logo"></span>
            ...
            <div class="wsmainfull menu clearfix">
                <div class="wsmainwp clearfix">
                    ...
                    <div class="desktoplogo">
                        <a href="#hero-25" class="logo-black"><img src="assets/images/timewellserved-logo.png" alt="logo"></a>
                    </div>


                    <!-- HEADER WHITE LOGO -->
                    <div class="desktoplogo">
                        <a href="#hero-25" class="logo-white"><img src="assets/images/logo-magenta-white.png" alt="logo"></a>
                    </div>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                    <div class="hero-25-txt wow fadeInRight">
                        ...
                        <!-- Title -->
                        <h2 class="s-52 w-700">Connect with Your Community</h2>

                        <!-- Text -->
                        <p class="p-lg">Make a difference in your community. Connect with meaningful volunteer opportunities that match your passion.
                        </p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-title mb-70">
                        ...
                        <!-- Title -->
                        <h2 class="s-48 w-700">Transform Yourself, Connect with Time Well Served!</h2>

                        <!-- Text -->
                        <p class="s-21 color--grey">Community service is meant to rehabilitate, not re-punish.</p>
                ...
                <div class="col-md-6">
                    <div class="txt-block right-column wow fadeInLeft">
                        ...
                        <div class="txt-box">
                            ...
                            <!-- Title -->
                            <h5 class="s-24 w-700">Centralized system</h5>

                            <!-- Text -->
                            <p>Find verified opportunities ipsum undo congue laoreet turpis neque auctor turpis
                        ...
                        <div class="txt-box mb-0">
                            ...
                            <!-- Title -->
                            <h5 class="s-24 w-700">Fragmented tracking</h5>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 order-last order-md-2">
                    <div class="txt-block left-column wow fadeInRight">
                        ...
                        <!-- Title -->
                        <h2 class="s-46 w-700">Simple. Compliant. Empowering.</h2>

                        <!-- Text -->
                        <p>Time Well Served connects volunteers, nonprofits, and case managers on one trusted platform
                            that makes community service work for everyone.
                        </p>

                        <!-- Text -->
                        <p class="mb-0">For Volunteers:
                            <ul>
                            <li>Find verified service opportunities that match your interests and schedule</li>
                            <li>Log hours with GPS check-ins and supervisor sign-offs</li>
                            <li>Track progress in real-time with clear deadline visibility</li>
                            <li>Receive automated reminders to stay on schedule</li>
                            <li>Store signed logs for seamless court submission</li>
                        </ul>
                        </p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-11 col-lg-9">
                            <div class="section-title wow fadeInUp mb-60">
                                ...
                                <!-- Title -->
                                <h2 class="s-48 w-700">Built for Real Users, Real Needs</h2>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 order-last order-md-2">
                    <div class="txt-block left-column wow fadeInRight">
                        ...
                        <!-- Title -->
                        <h2 class="s-46 w-700">For Case Managers:</h2>
                        ...
                        <ul class="simple-list">
                            ...
                            <li class="list-item">
                                <p class="mb-0">Monitor all parolees from one government-authorized dashboard</p>
                            </li>

                            <li class="list-item">
                                <p class="mb-0">View upcoming deadlines and total hours at a glance</p>
                            </li>

                            <li class="list-item">
                                <p class="mb-0">Verify submissions and approve hours instantly</p>
                            </li>

                            <li class="list-item">
                                <p class="mb-0">Generate reports and close cases efficiently</p>
                            </li>

                            <li class="list-item">
                                <p class="mb-0">Cut administrative time in half</p>
                            </li>
                        ...
                        <!-- Link -->
                        <div class="txt-block-tra-link mt-25">
                            <a href="#features-2" class="tra-link ico-20 color--theme">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-80">
                        ...
                        <!-- Title -->
                        <h2 class="s-48 w-700">Everything in One Place</h2>
                ...
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-1 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">For Volunteers</h6>
                                <p>Find your next meaningful service opportunity [Sign Up as Volunteer]</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-2 wow fadeInUp">
                            ...
                            <!-- Image -->
                            <div class="fbox-img gr--whitesmoke h-175">
                                <img class="img-fluid" src="assets/images/f_11.png" alt="feature-image">
                            </div>

                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">For Case Managers</h6>
                                <p>Request access to our government dashboard [Demo]</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-3 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">For Nonprofits</h6>
                                <p>Join our network of verified organizations [Partner With Us]</p>
                            </div>
    ...
    <!-- FEATURES-13
    ============================================= -->
    <section id="features-13" class="shape--bg shape--white-400 pt-100 features-section division">
        <div class="container">
            <div class="row d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="fb-12-1" class="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                    ...
                                    <!-- Text -->
                                    <div class="fbox-txt">
                                        <h5 class="s-20 w-700">Smart Matching</h5>
                                ...
                                <div id="fb-12-2" class="fbox-12 bg--white-100 block-shadow r-12">
                                    ...
                                    <!-- Text -->
                                    <div class="fbox-txt">
                                        <h5 class="s-20 w-700">Verified Check-In</h5>
                                        <p>Porta semper lacus and cursus feugiat at primis ultrice a ligula auctor</p>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                    ...
                                    <!-- Text -->
                                    <div class="fbox-txt">
                                        <h5 class="s-20 w-700">Real-Time Tracking</h5>
                                        <p>Porta semper lacus and cursus feugiat at primis ultrice a ligula auctor</p>
                                    </div>
                                ...
                                <div id="fb-12-4" class="fbox-12 bg--white-100 block-shadow r-12">
                                    ...
                                    <!-- Text -->
                                    <div class="fbox-txt">
                                        <h5 class="s-20 w-700">Automated Compliance</h5>
                                        <p>Porta semper lacus and cursus feugiat at primis ultrice a ligula auctor</p>
                                    </div>
                    ...
                    <div class="txt-block left-column wow fadeInRight">
                        ...
                        <div class="cbox-2 process-step">
                            ...
                            <div class="cbox-2-txt">
                                <h5 class="s-22 w-700">Smart Opportunity Matching</h5>
                                <p>Filter by location, schedule, interests, and specific court requirements
                        ...
                        <div class="cbox-2 process-step">
                            ...
                            <!-- Text -->
                            <div class="cbox-2-txt">
                                <h5 class="s-22 w-700">GPS Location Verification</h5>
                                <p>Tamper-proof check-ins ensure accurate hour logging nemo purus in lipsum purus
                                    sapien quaerat a primis viverra tellus vitae luctus dolor ipsum neque ligula
                                    quaerat
                                </p>
                            </div>
                        ...
                        <div class="cbox-2 process-step">
                            ...
                            <!-- Text -->
                            <div class="cbox-2-txt">
                                <h5 class="s-22 w-700">Case Manager Dashboard</h5>
                                <p class="mb-0">Government-authorized oversight with instant reporting nemo purus in
    ...
    <section class="pt-100 ws-wrapper content-section">
        <div class="container">
            <div class="bc-1-wrapper bg--white-400 r-16">
                <div class="section-overlay">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="txt-block right-column wow fadeInLeft">
                                ...
                                <!-- Title -->
                                <h2 class="s-46 w-700">Transforming Lives, One Hour at a Time</h2>
                                ...
                                <!-- Small Title -->
                                <h5 class="s-24 w-700 h5-title">The smarter way to connect</h5>

                                <!-- Text -->
                                <p class="mb-0">Volunteers complete service requirements without stress or confusion
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-70">
                        ...
                        <!-- Title -->
                        <h2 class="s-48 w-700">Track the progress towards objectives with key results</h2>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-5 fb-2 gr--smoke r-16 wow fadeInUp">
                            ...
                            <div class="fbox-5-img">
                                <img class="img-fluid" src="assets/images/f_07.png" alt="feature-image">
                            </div>
                    ...
                    <div class="txt-block left-column wow fadeInRight">
                        ...
                        <div class="cbox-4">
                            ...
                            <div class="box-title">
                                ...
                                <h5 class="s-24 w-700">Automatic workflows</h5>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-70">
                        ...
                        <!-- Title -->
                        <h2 class="s-48 w-700">Questions & Answers</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="questions-holder">
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Question -->
                                <h5 class="s-22 w-700"><span>1.</span> Getting started with Time Well Served</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="questions-holder">
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Question -->
                                <h5 class="s-22 w-700"><span>4.</span> How does TimeWellServed handle my privacy?</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="banner-3-txt color--white">
                                ...
                                <!-- Title -->
                                <h2 class="s-48 w-700">Starting with Time Well Served is easy, fast and free</h2>

                                <!-- Text -->
                                <p class="p-xl">It only takes a few clicks to get started</p>

                                <!-- Button -->
                                <a href="#" class="btn r-04 btn--theme hover--tra-white" data-bs-toggle="modal" data-bs-target="#modal-3">Get started - it's free</a>

                                <!-- Button Text -->
                                <p class="p-sm btn-txt ico-15">
                                    <span class="flaticon-check"></span> It's Free! - no credit card required.
                                </p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="modal-body-img">
                        <img class="img-fluid" src="assets/images/modal-newsletter-purple.jpg" alt="content-image">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    <div class="footer-info">
                        <img class="footer-logo" src="assets/images/timewellserved-logo.png" alt="footer-logo">
                    </div>
                </div>
            ...
            <div class="bottom-footer">
                <div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
                    ...
                    <!-- FOOTER COPYRIGHT -->
                    <div class="col">
                        <div class="footer-copyright"><p class="p-sm">&copy; 2025 Time Well Served. <span>All Rights Reserved</span></p></div>
                    </div>
                    ...
                    <div class="col">
                        <div class="bottom-secondary-link ico-15 text-end">
                            <p class="p-sm"><a href="https://themeforest.net/user/dsathemes/portfolio">Made with
                                    <span class="flaticon-heart color--theme"></span> by @Tokslawdev</a>
                            </p>
                        </div>
                    </div>
